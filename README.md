...
Описание философии, системной модели и принципов, на которых построен проект.

## [Вопросы / Ответы](FAQ.md)

Наиболее часто задаваемые вопросы о целях проекта, отличиях от других систем, и архитектурных решениях.